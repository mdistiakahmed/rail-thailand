...
export const metadata: Metadata = {
  title:
    "Thailand Train List (2026) - All SRT Train Numbers & Routes | RailThailand",
  description:
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-700 max-w-3xl mx-auto leading-relaxed">
            Explore the complete directory of Thailand train services operated
            by the State Railway of Thailand (SRT). This page lists all official
            train numbers, including Special Express, Express, Rapid, and
            Ordinary services running between major destinations such as
            Bangkok, Chiang Mai, Hat Yai, Nong Khai, Ubon Ratchathani, and Surat
            Thani.
          </p>

          <p className="text-gray-600 max-w-3xl mx-auto mt-4 leading-relaxed">
            Click on any train below to view detailed schedules, departure and
            arrival times, route stops, and service information. Whether you are
            planning long-distance travel or regional journeys, this Thailand
            railway train list helps you quickly find the correct train number
            for your trip.
          </p>
        </div>
