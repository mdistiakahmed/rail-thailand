...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for RailThailand - Your trusted source for Thailand train schedules and travel information",
};
    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          ...
          you use our services, subscribe to our newsletter, or contact us. The
      ...
      <section>
        ...
        <p>
          ...
          at{" "}
          <a
            href="mailto:privacy@railthailand.com"
