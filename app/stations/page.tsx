...
function groupRoutesByStartStation(routes: string[]): Record<string, string[]> {
  const grouped = routes.reduce((groups, routeName) => {
    const [startStation] = routeName.split(" - ");
    if (!groups[startStation]) {
      groups[startStation] = [];
    }
    groups[startStation].push(routeName);
    return groups;
  }, {} as any);
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-700 mb-6">
            Explore all major Thailand railway stations and check station wise
            train schedules, departure routes, and railway connections across
            the country. Whether you are traveling from Bangkok, Chiang Mai,
            Ayutthaya, or southern Thailand, you can easily find detailed
            railway station information and available train routes.
          </p>
        </div>
