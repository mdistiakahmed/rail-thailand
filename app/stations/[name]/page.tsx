          ...
          {routes.length > 0 ? (
            ...
            <>
              ...
              <p className="text-gray-700">
                ...
                {stationName} Railway Station in Thailand. Check back for
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        ...
                        from {from} Railway Station to {to}, Thailand.
                      </p>
                    </div>
