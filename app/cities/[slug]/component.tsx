                ...
                <div className="flex justify-between items-start mb-2">
                  <span className="font-semibold text-lg">
                    ...
                    {routeTo
                      ...
                      .join(" ")}{" "}
                    train schedule, timetable & SRT train times
                  </span>
                  {isCurrentRoute && (
...
export function generateRouteFAQ(trips: any[], from: string, to: string) {
  ...
  const trainTypes = Array.from(new Set(trips.map((t) => t.train_type))).join(
    ", ",
  );
