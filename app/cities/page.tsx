...
const CITY_ROUTES = BASE_ROUTES.flatMap((route) => {
  const reverseSlug = `${route.to
    .toLowerCase()
    .replace(/\s+/g, "-")}-to-${route.from.toLowerCase().replace(/\s+/g, "-")}`;
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <section className="text-center mb-16">
          ...
          <p className="text-gray-700 max-w-4xl mx-auto text-lg leading-relaxed">
            Browse complete Thailand train schedules for major intercity railway
            routes operated by the State Railway of Thailand (SRT). Compare
            departure times, estimated travel duration, train frequency, and
            station stops for popular routes including Bangkok to Chiang Mai,
            Bangkok to Pattaya, Bangkok to Ayutthaya, Hua Hin, Surat Thani and
            southern Thailand railway connections.
          </p>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
            {CITY_ROUTES.map((route, index) => (
              <a key={index} href={`/cities/${route.slug}`} className="group">
        ...
        <section className="mt-20 bg-blue-50 rounded-3xl p-10 border border-blue-100">
          ...
          <p className="text-gray-700 leading-relaxed mb-5">
            ...
            Each route includes departure times, arrival times, journey
            duration, train types (Express, Rapid, Special Express, Local), and
            key station stops along the railway corridor.
          </p>

          <p className="text-gray-700 leading-relaxed mb-5">
            Whether you are traveling from Bangkok to northern Thailand, heading
            south to Surat Thani for island transfers, commuting to Pattaya, or
            planning an overnight sleeper train to Chiang Mai, comparing
            Thailand railway schedules helps you select the most convenient
            departure.
          </p>

          <p className="text-gray-700 leading-relaxed">
            All timetable information is organized for easy comparison, allowing
            travelers to quickly evaluate travel duration, departure frequency,
            and arrival times between major Thai cities.
          </p>
        </section>
        ...
        <section className="mt-20">
          ...
          <div className="grid md:grid-cols-2 gap-8 text-gray-700 leading-relaxed">
            <div>
              ...
              <p>
                Morning departures offer convenient same-day arrival, while
                overnight sleeper trains are popular for long-distance routes
                such as Bangkok to Chiang Mai.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                services. Travel time varies depending on train type and number
                of stops.
              </p>
            </div>
